...
def get_args_parser():
    ...
    parser.add_argument('--eval', default='test', type=str, choices=('test', 'topn'), help="Type of evaluation you want to execute")
    parser.add_argument('--n', default=1, type=int, help="Number of best song recommandations to retrieve")
